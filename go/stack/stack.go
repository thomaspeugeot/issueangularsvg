...
import (
	...
	"issueangularsvg/go/fullstack"
	"issueangularsvg/go/models"
	"issueangularsvg/go/orm"
	"issueangularsvg/go/probe"

	issueangularsvg_go "issueangularsvg/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "issueangularsvg/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, issueangularsvg_go.GoModelsDir, issueangularsvg_go.GoDiagramsDir,
