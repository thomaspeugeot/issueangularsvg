...
import (
	...
	issueangularsvg_orm "issueangularsvg/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*issueangularsvg_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*issueangularsvg_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *issueangularsvg_orm.BackRepoStruct, stackPath string) {
