...
import { IssueangularsvgModule } from 'issueangularsvg'
import { IssueangularsvgspecificModule } from 'issueangularsvgspecific'
...
@NgModule({
  ...
  imports: [
    ...
    IssueangularsvgModule,
    IssueangularsvgspecificModule,
  ],
  providers: [
  ],
